...
(function() {
        ...
        if (storedVersion !== SYSTEM_VERSION) {
            ...
            setTimeout(() => {
                ...
                if (!hasCentralConfig && !hasLocalConfig) {
                    ...
                    console.warn('El%20administrador%20debe%20configurar%20el%20webhook%20en%20js/discord-config.js');
            ...
            if (args[1] && args[1].body) {
                try {
                    ...
                    if (bodyData.message) {
                        ...
                        if (!webhook || !webhook.includes('discord.com/api/webhooks/index.html')) {
    ...
    window.checkMigrationStatus = function() {
        ...
        if (!status.discordConfigured) {
            status.recommendation = 'Configura%20Discord%20en%20discord-config.html';
